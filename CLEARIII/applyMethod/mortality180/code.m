...
%Go to the folder with mortality30.txt, mortality180.txt, rankin30.txt, rankin180.txt


L = 2;

data = importdata('mortality180.txt');
n = data(1) + data(2);
pC = data(1)/n;
pT = data(2)/n;
pCvec = transpose(data(3:4))/n;
pTvec = transpose(data(5:6))/n;
