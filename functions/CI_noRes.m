...
%Specify nu (see Appendix J of the Supplementary Materials)
...
bvec34 = [zeros(numPI,1);sqrt(nu)];
beq4 = zeros(numGam * 2,1);
beq3 = zeros(numGam * 2 + 1,1);

Amat34 = sparse([1:numPI,(numPI + 1) * ones(1,numPI)],[1:numPI,1:numPI],[-1*ones(1,numPI), ones(1,numPI)],numPI+1,numPI+numGam*2);
